...
export default function Page() {
  ...
  const section = SECTION_MAP['collaterals']
  return (
    <SectionShell title={section.label} description={section.description}>
      <div className="space-y-6">
        <FileUploadGallery sectionKey="collaterals" />
        <TaskTextBoxes sectionKey="collaterals" weekStart={weekStart} lastWeekKey="tasks_last_week" thisWeekKey="tasks_this_week" />
      </div>
    </SectionShell>
  )
}
